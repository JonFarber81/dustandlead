...
from constants import (
    BONUS_TOUGH_HP, BONUS_LONGSHOT_RANGE_MULTIPLIER, BONUS_LONGSHOT_ACCURACY_PENALTY,
    BONUS_QUICKDRAW_DAMAGE_BONUS, BONUS_EAGLE_EYE_ACCURACY_BONUS, 
    BONUS_GUNSLINGER_CRIT_CHANCE, BONUS_DESPERADO_DAMAGE_TAKEN_MULTIPLIER,
    BONUS_DESPERADO_DAMAGE_DEALT_MULTIPLIER
)
...
class PlayerBonus:
    ...
    QUICKDRAW = {
        ...
        'stats': {
            'damage_bonus': BONUS_QUICKDRAW_DAMAGE_BONUS
        }
    }
    ...
    EAGLE_EYE = {
        ...
        'stats': {
            'accuracy_bonus': BONUS_EAGLE_EYE_ACCURACY_BONUS
        }
    }
    ...
    GUNSLINGER = {
        ...
        'stats': {
            'crit_chance': BONUS_GUNSLINGER_CRIT_CHANCE
        }
    }
